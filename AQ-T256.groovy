    ...
    stages {
        ...
        stage("pre-tests") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o pre_tests-AQT256.xml -r NONE -l NONE pre_tests-AQT256.robot'''
                    }
                }
                dir("src_tests/robot/reports") {
                    bat '''rebot -o combined.xml pre_tests-AQT256.xml'''
                }
            }
        }
        ...
        stage("configure DUT") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o configure_dut.xml -r NONE -l NONE configure_dut.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml configure_dut.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml configure_dut.xml'''
                        }
                    }
                }
            }
        ...
        stage("robot tests") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o smoke_tests-AQT256.xml -r NONE -l NONE smoke_tests-AQT256.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml smoke_tests-AQT256.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml smoke_tests-AQT256.xml'''
                        }
                    }
                }
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o Prot_tests-AQT256.xml -r NONE -l NONE prot_tests-AQT256.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml prot_tests-AQT256.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml prot_tests-AQT256.xml'''
                        }
                    }
                }
            }
