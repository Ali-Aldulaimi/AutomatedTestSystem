...
Conf03: Initialize connection to the DUT via AQtivate
    ...
    Should Not Contain	 ${result.stdout}  [error] --- Traceback
Conf04: Configure CT
    ${result} =	Run Process	 java  -jar  ../tools/sikulixide-2.0.5.jar  -r  ../sikulix/sik_dut_configuration_ct_AQ256.py
    Should Not Contain	 ${result.stdout}  [error] --- Traceback
Conf05: Configure VT
...
Conf06: Configure Generator Module
    ${result} =	Run Process	 java  -jar  ../tools/sikulixide-2.0.5.jar  -r  ../sikulix/sik_dut_configuration_generator_module_AQ256.py
    Should Not Contain	 ${result.stdout}  [error] --- Traceback
