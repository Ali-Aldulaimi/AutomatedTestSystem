...
Conf03: Initialize connection to the DUT via AQtivate
    ...
    Should Not Contain	 ${result.stdout}  [error] --- Traceback
Conf04: Configure CT
    ${result} =	Run Process	 java  -jar  ../tools/sikulixide-2.0.5.jar  -r  ../sikulix/sik_dut_configuration_ct_AQ255.py
    Should Not Contain	 ${result.stdout}  [error] --- Traceback
Conf05: Configure VT
    ${result} =	Run Process	 java  -jar  ../tools/sikulixide-2.0.5.jar  -r  ../sikulix/sik_dut_configuration_vt_AQ255.py
    Should Not Contain	 ${result.stdout}  [error] --- Traceback
Conf06: Configure digital inputs
    ${result} =	Run Process	 java  -jar  ../tools/sikulixide-2.0.5.jar  -r  ../sikulix/sik_dut_configuration_dig_io.py
    Should Not Contain	 ${result.stdout}  [error] --- Traceback}
Conf07: Close AQtivate
