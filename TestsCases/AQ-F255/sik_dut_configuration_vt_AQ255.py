...
wait(2)
click(Pattern("aq_menutabs_trafos_ct1_vt1.png").targetOffset(46,8))
wait(2)
mouseMove("aq_param_voltage_meas_mode.png")
mouseMove(1200, 0)
...
mouseDown(Button.LEFT)
mouseUp(Button.LEFT)
mouseMove("aq_param_vt_pri.png")
mouseMove(1200, 0)
mouseDown(Button.LEFT)
mouseUp(Button.LEFT)
type("a", Key.CTRL)
type("100"+Key.ENTER)
mouseMove("aq_param_vt_sec.png")
mouseMove(1200, 0)
mouseDown(Button.LEFT)
mouseUp(Button.LEFT)
type("a", Key.CTRL)
