    ...
    stages {
        ...
        stage("pre-tests") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o pre_tests-AQT257.xml -r NONE -l NONE pre_tests-AQT257.robot'''
                    }
                }
                dir("src_tests/robot/reports") {
                    bat '''rebot -o combined.xml pre_tests-AQT257.xml'''
                }
            }
        }
        ...
        stage("configure DUT") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o configure_dut_AQ257.xml -r NONE -l NONE configure_dut_AQ257.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml configure_dut_AQ257.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml configure_dut_AQ257.xml'''
                        }
                    }
                }
            }
        ...
        stage("robot tests") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o smoke_tests-AQT257.xml -r NONE -l NONE smoke_tests-AQT257.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml smoke_tests-AQT257.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml smoke_tests-AQT257.xml'''
                        }
                    }
                }
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o prot_tests-AQT257 -r NONE -l NONE prot_tests-AQT257.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml prot_tests-AQT257.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml prot_tests-AQT257.xml'''
                        }
                    }
                }
            }
