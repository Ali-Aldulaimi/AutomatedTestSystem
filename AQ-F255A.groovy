    ...
    stages {
        ...
        stage("pre-tests") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o pre_tests-AQF255A.xml -r NONE -l NONE pre_tests-AQF255A.robot'''
                    }
                }
                dir("src_tests/robot/reports") {
                    bat '''rebot -o combined.xml pre_tests-AQF255A.xml'''
                }
            }
        }
        ...
        stage("configure DUT") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o configure_dut_AQ255.xml -r NONE -l NONE configure_dut_AQ255.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml configure_dut_AQ255.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml configure_dut_AQ255.xml'''
                        }
                    }
                }
            }
        ...
        stage("robot tests") {
            ...
            steps {
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o smoke_tests-AQF255A.xml -r NONE -l NONE smoke_tests-AQF255A.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml smoke_tests-AQF255A.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml smoke_tests-AQF255A.xml'''
                        }
                    }
                }
                catchError() {
                    dir("src_tests/robot") {
                        bat '''robot -d reports -o Prot_tests-AQF255A.xml -r NONE -l NONE prot_tests-AQF255A.robot'''
                    }
                }
                script {
                    if (fileExists('src_tests/robot/reports/combined.xml')) {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml combined.xml prot_tests-AQF255A.xml'''
                        }
                    }
                    else {
                        dir("src_tests/robot/reports") {
                            bat '''rebot -o combined.xml prot_tests-AQF255A.xml'''
                        }
                    }
                }
            }
